...
<?php echo tep_draw_form('product_reviews_write', tep_href_link('product_reviews_write.php', 'action=process&products_id=' . $_GET['products_id']), 'post', 'onsubmit="return checkForm();"', true); ?>
...
?>
  ...
  <div class="buttonSet">
    ...
    <?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link('product_reviews.php', tep_get_all_get_params(array('reviews_id', 'action')))); ?>
  </div>
</div>
