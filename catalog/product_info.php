...
?>
        <a href="<?php echo tep_href_link('images/products/originals/' . $product_info['products_image'], '', 'SSL', false, false); ?>" class="lightbox"><?php echo tep_image('images/products/originals/' . $product_info['products_image'], addslashes($product_info['products_name']), SMALL_IMAGE_WIDTH*2, SMALL_IMAGE_HEIGHT*2); ?></a>
<?php
