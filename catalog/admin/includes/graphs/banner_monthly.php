...
*/
  ...
  $banner_stats_query = tep_db_query("select month(banners_history_date) as banner_month, sum(banners_shown) as value, sum(banners_clicked) as dvalue from banners_history where banners_id = '" . (int)$banner_id . "' and year(banners_history_date) = '" . (int)$year . "' group by banner_month");
