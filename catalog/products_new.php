...
?>
      <tr>
        <td width="<?php echo SMALL_IMAGE_WIDTH + 10; ?>" align="center" class="main"><?php echo '<a href="' . tep_href_link('product_info.php', 'products_id=' . $products_new['products_id']) . '">' . tep_image('images/products/thumbs/' . $products_new['products_image'], $products_new['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>'; ?></td>
