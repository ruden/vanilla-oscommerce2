...
<?php echo tep_draw_form('account_password', tep_href_link('account_password.php', '', 'SSL'), 'post', 'onsubmit="return check_form(account_password);"', true) . tep_draw_hidden_field('action', 'process'); ?>

  <div class="col-lg-6 mb-5">
    <div class="text-right text-danger small"><?php echo FORM_REQUIRED_INFORMATION; ?></div>

    <div class="mb-3">
      <label class="form-label" for="password_current"><?php echo ENTRY_PASSWORD_CURRENT . (tep_not_null(ENTRY_PASSWORD_CURRENT_TEXT) ? '<span class="text-danger ml-1">' . ENTRY_PASSWORD_CURRENT_TEXT . '</span>' : ''); ?></label>
