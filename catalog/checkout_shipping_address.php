        ...
        <div class="mb-3">
          <table class="table table-borderless table-sm">
            ...
            while ($addresses = tep_db_fetch_array($addresses_query)) {
              ...
              <td class="text-right form-check"><?php echo tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $sendto), 'class="form-check-input float-none"'); ?></td>
              </tr>
              <tr>
                <td colspan="2">
