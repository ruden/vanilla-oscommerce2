        ...
        <table class="table table-hover">
          ...
          while ($history = tep_db_fetch_array($history_query)) {
            ...
            <tr>
              ...
              <td class="text-right"><?php echo tep_draw_button(SMALL_IMAGE_BUTTON_VIEW, 'document', tep_href_link('account_history_info.php', (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&' : '') . 'order_id=' . $history['orders_id'], 'SSL'), 'btn-primary btn-sm'); ?></td>
            </tr>
