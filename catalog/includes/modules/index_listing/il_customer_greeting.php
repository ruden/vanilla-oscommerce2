...
*/
  ...
  class il_customer_greeting {
    ...
    public function execute() {
      ...
      ob_start();
      include(DIR_WS_MODULES . $this->group . '/templates/customer_greeting.php');
    ...
    public function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_INDEX_LISTING_CUSTOMER_GREETING_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
    }
