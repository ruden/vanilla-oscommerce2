<h2><?php echo MODULE_INDEX_LISTING_UPCOMING_PRODUCTS_BOX_TITLE; ?></h2>
<div class="contentText">
  <ul style="margin: 0; padding: 0;">

    <?php
    foreach ($expected_products as $products) {
      ?>
...
<a href="' . tep_href_link('product_info.php', 'products_id=' . $products['products_id']) . '">' . $products['products_name'] . '</a><br />' . tep_date_short($products['date_expected']);
        ?>
