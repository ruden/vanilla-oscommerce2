...
class il_new_products {
  ...
  public function execute() {
    ...
    if (tep_db_num_rows($new_products_query) > 0) {
      ...
      ob_start();
      include('includes/modules/' . $this->group . '/templates/new_products.php');
  ...
  public function install() {
    ...
    tep_db_query("INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'MODULE_INDEX_LISTING_NEW_PRODUCTS_SORT_ORDER', '200', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
  }
  ...
  public function keys() {
    return array('MODULE_INDEX_LISTING_NEW_PRODUCTS_STATUS', 'MODULE_INDEX_LISTING_NEW_PRODUCTS_MAX_DISPLAY_PRODUCTS', 'MODULE_INDEX_LISTING_NEW_PRODUCTS_SORT_ORDER');
  }
}
