<div class="t-attributes mb-3">
  ...
  foreach ($products_attributes_array as $products_attributes) {
    ...
    <div class="mb-3">
      ...
      <?php echo tep_draw_pull_down_menu('id[' . $products_attributes['id'] . ']', $products_attributes['array'], $products_attributes['selected_attribute'], 'class="form-control w-auto" id="id[' . $products_attributes['id'] . ']"'); ?>
    </div>
