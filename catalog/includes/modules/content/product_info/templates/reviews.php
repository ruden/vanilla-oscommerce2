  ...
  foreach ($reviews_array as $reviews) {
    ...
    <div class="mb-5" id="reviews-<?php echo $reviews['reviews_id']; ?>">
      ...
      <div class="mb-2">
        ...
        <span class="font-weight-bold"><?php echo TEXT_BY; ?><?php echo tep_output_string_protected($reviews['customers_name']); ?></span>
        <span class="float-right"><?php echo sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating']) . ' ' . tep_draw_stars($reviews['reviews_rating']); ?></span>
      </div>
