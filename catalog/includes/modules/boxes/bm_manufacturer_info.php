    ...
    function execute() {
      ...
      if (isset($_GET['products_id'])) {
        ...
        if (tep_db_num_rows($manufacturer_query)) {
          ...
          if (tep_not_null($manufacturer['manufacturers_image'])) $manufacturer_info_string .= '<tr><td align="center" colspan="2">' . tep_image('images/manufacturers/' . $manufacturer['manufacturers_image'], $manufacturer['manufacturers_name']) . '</td></tr>';
