...
// class constructor
    function __construct() {
      ...
      $this->order_status = defined('MODULE_PAYMENT_2CHECKOUT_ORDER_STATUS_ID') && ((int)MODULE_PAYMENT_2CHECKOUT_ORDER_STATUS_ID > 0) ? (int)MODULE_PAYMENT_2CHECKOUT_ORDER_STATUS_ID : 0;
...
// class methods
    function update_status() {
      ...
      if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_2CHECKOUT_ZONE > 0) ) {
        $check_flag = false;
        $check_query = tep_db_query("select zone_id from zones_to_geo_zones where geo_zone_id = '" . MODULE_PAYMENT_2CHECKOUT_ZONE . "' and zone_country_id = '" . (int)$order->billing['country']['id'] . "' order by zone_id");
